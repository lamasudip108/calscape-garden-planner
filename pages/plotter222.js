            ...
            <div className="column left" style={{backgroundColor: "#fff;"}}>
                <div id="toolbar-gardenplanner">
                    <div id="object-menu-full" className="toolbar-gardenplanner-menu">
                        {/*<button id="object-menu-garden-button"*/}
                        {/*className="toolbar-gardenplanner-toggle toggle-submenu no-tooltip-handler activated target-visible"*/}
                        {/*data-bs-placement="top" data-bs-html="true" data-bs-original-title="GARDEN PLAN"*/}
                        {/*data-bs-toggle="tooltip" data-toggle-target="object-menu-garden"*/}
                        {/*data-toggle-mode="garden"><img*/}
                        {/*className="inactive toolbar-main-icon" src="https://my-garden.gardena.com/assets/svg/icons/gartenplan_grey.svg"*/}
                        {/*title="GARDEN PLAN"/><img className="active toolbar-main-icon"*/}
                        {/*src="https://my-garden.gardena.com/assets/svg/icons/gartenplan_orange.svg" title="GARDEN PLAN"/>*/}
                        {/*</button>*/}
                        ...
                        <span className="gui-toolbar-group">
                            <img
                                ...
                                <div className="subgroup-wrapper only-objects level-1">
                                    <ul className="subgroup level-1">
                                        <li data-bs-placement="right" data-bs-html="true" data-bs-original-title="Lawns"
                                            ...
                                            <button className="button-item-gras item-buttons"
                                                    ...
                                                    data-item-name="Lawns" data-item-slug="gras" data-item-scale=""
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-erde item-buttons"
                                                    ...
                                                    data-item-name="Earth / bed" data-item-slug="erde"
                                                    data-item-scale=""
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-pflaster item-buttons"
                                                    ...
                                                    data-item-name="Paving" data-item-slug="pflaster" data-item-scale=""
                                                    data-item-priority="red" data-canvas-type="polygon"
                                                    data-canvas-pattern=""
                                                    data-canvas-geometry="" data-canvas-layer="landscape"
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true" data-bs-original-title="Wood"
                                            className="level-1 gardenplanner-element">
                                            <button className="button-item-holz item-buttons"
                                                    ...
                                                    data-item-name="Wood" data-item-slug="holz" data-item-scale=""
                                                    data-item-priority="red" data-canvas-type="polygon"
                                                    data-canvas-pattern=""
                                                    data-canvas-geometry="" data-canvas-layer="landscape"
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-kopfsteinpflaster item-buttons"
                                                    ...
                                                    data-item-scale="" data-item-priority="red"
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true" data-bs-original-title="Wall"
                                            ...
                                            <button className="button-item-mauer item-buttons"
                                                    ...
                                                    data-item-name="Wall" data-item-slug="mauer" data-item-scale=""
                                                ...
                                                <img
                                                    ...
                                                    className="icons"/><span
                                                className="text-turquoise d-block mx-auto small">Wall</span></button>
                                        </li>
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-kies item-buttons"
                                                    ...
                                                    data-item-name="Gravel" data-item-slug="kies" data-item-scale=""
                                                    data-item-priority="red" data-canvas-type="polygon"
                                                    data-canvas-pattern=""
                                                    data-canvas-geometry="" data-canvas-layer="landscape"
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true" data-bs-original-title="Water"
                                            ...
                                            <button className="button-item-wasser item-buttons"
                                                    ...
                                                    data-item-name="Water" data-item-slug="wasser" data-item-scale=""
                                                    data-item-priority="yellow" data-canvas-type="polygon"
                                                    data-canvas-pattern="" data-canvas-geometry=""
                                                    data-canvas-layer="landscape"
                            ...
                            <li className="has-subgroup level-1 gardenplanner-element scrollable-menu"
                                data-original-name="Houses and extensions"><span className="gui-toolbar-group">
                        <img
                            ...
                            alt="Houses and extensions" className="icons"/><span
                                className="text-turquoise d-block mx-auto small">Houses and extensions</span></span>
                                <div className="subgroup-wrapper level-1 visible scrollable-checked"
                                     style={{height: "261px"}}>
                                    <ul className="subgroup level-1" style={{height: "261px"}}>
                                        <li className="has-subgroup only-objects level-2 first gardenplanner-element scrollable-menu"
                                            data-original-name="Houses and boundaries"><span
                                                ...
                                                <ul className="subgroup level-2 first">
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-doppelgarage item-buttons"
                                                                ...
                                                                data-item-name="House" data-item-slug="doppelgarage"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-carport item-buttons"
                                                                ...
                                                                data-item-name="Carport" data-item-slug="carport"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-erker_halbrund item-buttons"
                                                                ...
                                                                data-item-name="Bay" data-item-slug="erker_halbrund"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-erker_trapezoid item-buttons"
                                                                ...
                                                                data-item-name="Bay" data-item-slug="erker_trapezoid"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-erker_eckig item-buttons"
                                                                ...
                                                                data-item-name="Bay" data-item-slug="erker_eckig"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:2.5}"
                                                                data-item-priority="red" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="level-2 gardenplanner-element">
                                                        <button className="button-item-aussentreppe_rund item-buttons"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        data-bs-original-title="Stairs"
                                                        className="level-2 gardenplanner-element">
                                                        <button className="button-item-aussentreppe_trapez item-buttons"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-aussenbalkon item-buttons"
                                                                ...
                                                                data-item-name="Balcony" data-item-slug="aussenbalkon"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-vordach_grau item-buttons"
                                                                ...
                                                                data-item-name="Canopy" data-item-slug="vordach_grau"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:2.5}"
                                                                data-item-priority="red" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-vordach_rot item-buttons"
                                                                ...
                                                                data-item-name="Canopy" data-item-slug="vordach_rot"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:2.5}"
                                                                data-item-priority="red" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-vordach_gruen item-buttons"
                                                                ...
                                                                data-item-name="Canopy" data-item-slug="vordach_gruen"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:2.5}"
                                                                data-item-priority="red" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            ...
                                            alt="Terraces and surfaces" className="icons"/><span
                                                ...
                                                <ul className="subgroup level-2">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-beet_eckig item-buttons"
                                                                ...
                                                                data-item-name="Bed, rect." data-item-slug="beet_eckig"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-beet_rund item-buttons"
                                                                data-item-graphic="https://my-garden.gardena.com/assets/elements/png/kachel_erde.png"
                                                                data-item-name="Bed, round" data-item-slug="beet_rund"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="level-2 gardenplanner-element">
                                                        <button className="button-item-holzflaeche_eckig item-buttons"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="level-2 gardenplanner-element">
                                                        <button className="button-item-holzflaeche_rund item-buttons"
                                                                data-item-graphic="https://my-garden.gardena.com/assets/elements/png/kachel_holz.png"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="item-linebreak level-2 gardenplanner-element">
                                                        <button className="button-item-kiesflaeche_eckig item-buttons"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="level-2 gardenplanner-element">
                                                        <button className="button-item-kiesflaeche_rund item-buttons"
                                                                data-item-graphic="https://my-garden.gardena.com/assets/elements/png/kachel_kies.png"
                                            ...
                                            <div className="subgroup-wrapper only-objects level-2">
                                                <ul className="subgroup level-2">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="item-linebreak level-2 gardenplanner-element">
                                                        <button className="button-item-steinmauer_gerade item-buttons"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-rankgitter item-buttons"
                                                                ...
                                                                data-item-name="Trellis" data-item-slug="rankgitter"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-zaun_braun item-buttons"
                                                                ...
                                                                data-item-name="Brown fence" data-item-slug="zaun_braun"
                                                                data-item-scale="{&quot;x&quot;:2,&quot;y&quot;:0.4}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-zaun_weiss item-buttons"
                                                                ...
                                                                data-item-name="White fence" data-item-slug="zaun_weiss"
                                                                data-item-scale="{&quot;x&quot;:2,&quot;y&quot;:0.4}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                                ...
                                                <ul className="subgroup level-2">
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-spielhaus item-buttons"
                                                                ...
                                                                data-item-name="Playhouse" data-item-slug="spielhaus"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-pergola item-buttons"
                                                                ...
                                                                data-item-name="Pergola" data-item-slug="pergola"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-hochbeet item-buttons"
                                                                ...
                                                                data-item-name="Raised bed" data-item-slug="hochbeet"
                            ...
                            <li className="has-subgroup level-1 gardenplanner-element scrollable-menu"
                                data-original-name="Plants"><span className="gui-toolbar-group"><img
                                ...
                                <div className="subgroup-wrapper level-1">
                                    <ul className="subgroup level-1">
                                        <li className="has-subgroup only-objects level-2 first gardenplanner-element scrollable-menu"
                                                ...
                                                <ul className="subgroup level-2 first">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-laubbaum item-buttons"
                                                                ...
                                                                data-item-name="Deciduous" data-item-slug="laubbaum"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-ahorn item-buttons"
                                                                ...
                                                                data-item-name="Maple" data-item-slug="ahorn"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-nadelbaum item-buttons"
                                                                ...
                                                                data-item-name="Fir" data-item-slug="nadelbaum"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="580"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-birnenbaum item-buttons"
                                                                ...
                                                                data-item-name="Pear" data-item-slug="birnenbaum"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-apfelbaum item-buttons"
                                                                ...
                                                                data-item-name="Apple" data-item-slug="apfelbaum"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="560"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-kirschbaum item-buttons"
                                                                ...
                                                                data-item-name="Cherry" data-item-slug="kirschbaum"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="580"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-palme item-buttons"
                                                                ...
                                                                data-item-name="Palm" data-item-slug="palme"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="580"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-magnolie item-buttons"
                                                                ...
                                                                data-item-name="Magnolia" data-item-slug="magnolie"
                                                                data-item-scale="{&quot;x&quot;:2,&quot;y&quot;:2}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="560"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-eiche item-buttons"
                                                                ...
                                                                data-item-name="Oak" data-item-slug="eiche"
                                                                data-item-scale="{&quot;x&quot;:4,&quot;y&quot;:4}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-pinie item-buttons"
                                                                ...
                                                                data-item-name="Pine" data-item-slug="pinie"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="580"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-birke item-buttons"
                                                                ...
                                                                data-item-name="Birch" data-item-slug="birke"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="580"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-zypresse item-buttons"
                                                                ...
                                                                data-item-name="Cypress" data-item-slug="zypresse"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-guave item-buttons"
                                                                ...
                                                                data-item-name="Guava" data-item-slug="guave"
                                                                data-item-scale="{&quot;x&quot;:2,&quot;y&quot;:2}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="560"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-baumstumpf item-buttons"
                                                                ...
                                                                data-item-name="Tree stump" data-item-slug="baumstumpf"
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            data-original-name="Shrubs"><span className="gui-toolbar-group"><img
                                                ...
                                                <ul className="subgroup level-2">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-hecke item-buttons"
                                                                ...
                                                                data-item-name="Hedges" data-item-slug="hecke"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-strauch_lila item-buttons"
                                                                ...
                                                                data-item-name="Lilac" data-item-slug="strauch_lila"
                                                                data-item-scale="{&quot;x&quot;:1.2,&quot;y&quot;:1.2}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="225"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-strauch_weiss item-buttons"
                                                                ...
                                                                data-item-name="Elder" data-item-slug="strauch_weiss"
                                                                data-item-scale="{&quot;x&quot;:1.2,&quot;y&quot;:1.2}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="225"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-buchs item-buttons"
                                                                ...
                                                                data-item-name="Box, rect." data-item-slug="buchs"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="item-linebreak level-2 lastRow gardenplanner-element">
                                                        <button className="button-item-trockener_strauch item-buttons"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-kaktus item-buttons"
                                                                ...
                                                                data-item-name="Cactus" data-item-slug="kaktus"
                                                                data-item-scale="{&quot;x&quot;:0.6,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="225"
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            data-original-name="Flowers and grass"><span
                                            className="gui-toolbar-group"><img
                                                ...
                                                <ul className="subgroup level-2">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-blume_gelb item-buttons"
                                                                ...
                                                                data-item-name="Sunflower" data-item-slug="blume_gelb"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-blume_rot item-buttons"
                                                                ...
                                                                data-item-name="Rose" data-item-slug="blume_rot"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:1}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="228"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-blume_weiss item-buttons"
                                                                ...
                                                                data-item-name="Hydrangea" data-item-slug="blume_weiss"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:1}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-blume_flieder item-buttons"
                                                                ...
                                                                data-item-name="Lavender" data-item-slug="blume_flieder"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:1}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="205"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-blume_pink item-buttons"
                                                                ...
                                                                data-item-name="Tulip" data-item-slug="blume_pink"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:1}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="205"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-blume_blau item-buttons"
                                                                ...
                                                                data-item-name="Violet" data-item-slug="blume_blau"
                                                                data-item-scale="{&quot;x&quot;:1,&quot;y&quot;:1}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="205"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-farn item-buttons"
                                                                ...
                                                                data-item-name="Fern" data-item-slug="farn"
                                                                data-item-scale="{&quot;x&quot;:0.6,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="225"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-schilf item-buttons"
                                                                ...
                                                                data-item-name="Reeds" data-item-slug="schilf"
                                                                data-item-scale="{&quot;x&quot;:0.6,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="225"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-bambus item-buttons"
                                                                ...
                                                                data-item-name="Bamboo" data-item-slug="bambus"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            data-original-name="Fruit and veg"><span className="gui-toolbar-group"><img
                                            src="https://my-garden.gardena.com/assets/elements/png/erdbeere.png?v=20220628-2ec948a"
                                            alt="Fruit and veg"
                                            className="icons"/><span className="text-turquoise d-block mx-auto small">Fruit and veg</span></span>
                                            <div className="subgroup-wrapper only-objects level-2">
                                                <ul className="subgroup level-2">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-erdbeere item-buttons"
                                                                ...
                                                                data-item-name="Strawberries" data-item-slug="erdbeere"
                                                                data-item-scale="{&quot;x&quot;:0.6,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-himbeere item-buttons"
                                                                ...
                                                                data-item-name="Raspberries" data-item-slug="himbeere"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-johannisbeere item-buttons"
                                                                ...
                                                                data-item-name="Currants" data-item-slug="johannisbeere"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-tomate item-buttons"
                                                                ...
                                                                data-item-name="Tomatoes" data-item-slug="tomate"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-gurke item-buttons"
                                                                ...
                                                                data-item-name="Cucumber" data-item-slug="gurke"
                                                                data-item-scale="{&quot;x&quot;:0.8,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="230"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-rotkohl item-buttons"
                                                                ...
                                                                data-item-name="Cabbage" data-item-slug="rotkohl"
                                                                data-item-scale="{&quot;x&quot;:0.6,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="230"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-karotte item-buttons"
                                                                ...
                                                                data-item-name="Carrot" data-item-slug="karotte"
                                                                data-item-scale="{&quot;x&quot;:0.8,&quot;y&quot;:0.7}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="230"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-kartoffel item-buttons"
                                                                ...
                                                                data-item-name="Potato" data-item-slug="kartoffel"
                                                                data-item-scale="{&quot;x&quot;:0.8,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="230"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-blumenkohl item-buttons"
                                                                ...
                                                                data-item-name="Cauliflower" data-item-slug="blumenkohl"
                                                                data-item-scale="{&quot;x&quot;:0.6,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="plants" data-canvas-layerdepth="230"
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            data-original-name="Pots"><span className="gui-toolbar-group"><img
                            ...
                            <li className="has-subgroup level-1 gardenplanner-element scrollable-menu"
                                data-original-name="Furniture + Leisure"><span className="gui-toolbar-group"><img
                                ...
                                <div className="subgroup-wrapper level-1">
                                    <ul className="subgroup level-1">
                                                ...
                                                <ul className="subgroup level-2 first">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-kohlegrill_rund item-buttons"
                                                                ...
                                                                data-item-name="Grill" data-item-slug="kohlegrill_rund"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-smoker item-buttons"
                                                                ...
                                                                data-item-name="Smoker" data-item-slug="smoker"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-feuerstaette item-buttons"
                                                                ...
                                                                data-item-name="Fireplace" data-item-slug="feuerstaette"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-rutsche item-buttons"
                                                                ...
                                                                data-item-name="Slide" data-item-slug="rutsche"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-hundehuette item-buttons"
                                                                ...
                                                                data-item-name="Dog kennel" data-item-slug="hundehuette"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-freilaufgehege item-buttons"
                                                                ...
                                                                data-item-name="Pen" data-item-slug="freilaufgehege"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-sandkasten item-buttons"
                                                                ...
                                                                data-item-name="Sand box" data-item-slug="sandkasten"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-haengematte item-buttons"
                                                                ...
                                                                data-item-name="Hammock" data-item-slug="haengematte"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:1}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-trampolin item-buttons"
                                                                ...
                                                                data-item-name="Trampoline" data-item-slug="trampolin"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-pavillon item-buttons"
                                                                ...
                                                                data-item-name="Pavilion" data-item-slug="pavillon"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            data-original-name="Vehicles"><span className="gui-toolbar-group"><img
                                                ...
                                                <ul className="subgroup level-2">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button
                                                            ...
                                                            data-item-name="Limo" data-item-slug="auto_limousine_weiss"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-auto_suv_grau item-buttons"
                                                                ...
                                                                data-item-name="SUV" data-item-slug="auto_suv_grau"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-fahrrad item-buttons"
                                                                ...
                                                                data-item-name="Bicycle" data-item-slug="fahrrad"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-auto_anhaenger item-buttons"
                                                                ...
                                                                data-item-name="Trailer" data-item-slug="auto_anhaenger"
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            data-original-name="Furniture"><span className="gui-toolbar-group"><img
                                                ...
                                                <ul className="subgroup level-2">
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-gartenbank item-buttons"
                                                                ...
                                                                data-item-name="Bench" data-item-slug="gartenbank"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-gartenbank_holz item-buttons"
                                                                ...
                                                                data-item-name="Bench" data-item-slug="gartenbank_holz"
                                                                data-item-scale="{&quot;x&quot;:1.5,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="level-2 gardenplanner-element">
                                                        <button className="button-item-hollywoodschaukel item-buttons"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-sitzsack item-buttons"
                                                                ...
                                                                data-item-name="Beanbag" data-item-slug="sitzsack"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        className="item-linebreak level-2 lastRow gardenplanner-element">
                                                        <button className="button-item-gartenliege_lounge item-buttons"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-sonnenliege item-buttons"
                                                                ...
                                                                data-item-name="Sunbed" data-item-slug="sonnenliege"
                                                                data-item-scale="{&quot;x&quot;:2,&quot;y&quot;:0.8}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            data-original-name="Lighting"><span className="gui-toolbar-group"><img
                                                ...
                                                <ul className="subgroup level-2" style={{maxWidth: "280px"}}>
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-scheinwerfer item-buttons"
                                                                ...
                                                                data-item-name="Spotlight" data-item-slug="scheinwerfer"
                                                                data-item-scale="{&quot;x&quot;:0.6,&quot;y&quot;:0.6}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                                    ...
                                                    <li data-bs-placement="top" data-bs-html="true"
                                                        ...
                                                        <button className="button-item-laterne item-buttons"
                                                                ...
                                                                data-item-name="Lantern" data-item-slug="laterne"
                                                                data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                                data-item-priority="yellow" data-canvas-type="image"
                                                                data-canvas-pattern="" data-canvas-geometry=""
                                                                data-canvas-layer="structure"
                                        ...
                                        <li className="has-subgroup only-objects level-2 gardenplanner-element scrollable-menu"
                                            data-original-name="Other"><span className="gui-toolbar-group"><img
                            ...
                            <li className="has-subgroup only-objects level-1 gardenplanner-element scrollable-menu"
                                data-original-name="Ponds and pools"><span className="gui-toolbar-group"><img
                                    ...
                                    <ul className="subgroup level-1">
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-brunnen item-buttons"
                                                    ...
                                                    data-item-name="Fountain" data-item-slug="brunnen"
                                                    data-item-scale="{&quot;x&quot;:0.8,&quot;y&quot;:0.8}"
                                                    data-item-priority="red" data-canvas-type="image"
                                                    data-canvas-pattern=""
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-pool_eckig item-buttons"
                                                    ...
                                                    data-item-name="Rect. pool" data-item-slug="pool_eckig"
                                                    data-item-scale="{&quot;x&quot;:4,&quot;y&quot;:2}"
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-pool_rund item-buttons"
                                                    ...
                                                    data-item-name="Round pool" data-item-slug="pool_rund"
                                                    data-item-scale="{&quot;x&quot;:3,&quot;y&quot;:3}"
                                                    data-item-priority="red"
                                                    data-canvas-type="image" data-canvas-pattern=""
                                                    data-canvas-geometry=""
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-teich_gross item-buttons"
                                                    ...
                                                    data-item-name="Pond, large" data-item-slug="teich_gross"
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-teich_klein item-buttons"
                                                    ...
                                                    data-item-name="Pond, small" data-item-slug="teich_klein"
                                        ...
                                        <li data-bs-placement="right" data-bs-html="true"
                                            ...
                                            <button className="button-item-teich_oval item-buttons"
                                                    ...
                                                    data-item-name="Pond, oval" data-item-slug="teich_oval"
